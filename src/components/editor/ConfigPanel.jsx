  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="space-y-2">
        <h3 className="text-sm font-medium text-gray-700 border-b pb-2">Dimensions</h3>
        <div className="bg-gray-50 rounded-lg p-3">
          <p className="text-sm text-gray-600">
            <span className="font-medium">{config.dimensions.width}</span> x{' '}
            <span className="font-medium">{config.dimensions.height}</span> pixels
          </p>
      ...
      {hasAnimation && (
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-gray-700 border-b pb-2">Animation Timing</h3>

          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm text-gray-600 mb-1">Frame Duration</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm text-gray-600 mb-1">Frame Delay</label>
              <input
                type="number"
                ...
                step="0.1"
              />
              <p className="text-xs text-gray-400 mt-1">seconds between frames</p>
            </div>
          </div>
        </div>
      )}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                onChange={(e) => updateConfig('isiWidth', parseInt(e.target.value) || config.dimensions.width)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => updateConfig('isiHeight', parseInt(e.target.value) || 540)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>

            <div>
              <label className="block text-sm text-gray-600 mb-1">Top Position</label>
              <input
                type="number"
                value={config.isiTop}
                onChange={(e) => updateConfig('isiTop', parseInt(e.target.value) || 0)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>

            <div>
              <label className="block text-sm text-gray-600 mb-1">Left Position</label>
              <input
                type="number"
                value={config.isiLeft || 0}
                onChange={(e) => updateConfig('isiLeft', parseInt(e.target.value) || 0)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                onChange={(e) => updateConfig('isiBackgroundColor', e.target.value)}
      ...
      {hasISI && (
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-gray-700 border-b pb-2">ISI Scroller</h3>

          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm text-gray-600 mb-1">Auto-scroll Speed</label>
              <input
                type="number"
                value={config.autoScrollSpeed}
                onChange={(e) => updateConfig('autoScrollSpeed', parseInt(e.target.value) || 80)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                min="10"
                max="200"
              />
            ...
            <div>
              <label className="block text-sm text-gray-600 mb-1">Scroll Step</label>
              <input
                type="number"
                value={config.scrollStep}
                onChange={(e) => updateConfig('scrollStep', parseInt(e.target.value) || 5)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                min="1"
                max="20"
              />
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              ...
              <input
                ...
                onChange={(e) => updateConfig('scrollerWidth', parseInt(e.target.value) || 12)}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => updateConfig('scrollerHeight', parseInt(e.target.value) || 35)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                min="20"
                max="100"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => updateConfig('scrollerBorderRadius', parseInt(e.target.value) || 50)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                min="0"
                max="50"
              />
      ...
      {hasExpandable && (
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-gray-700 border-b pb-2">Expandable ISI</h3>

          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm text-gray-600 mb-1">Expanded Height</label>
              <input
                type="number"
                value={config.expandedHeight}
                onChange={(e) => updateConfig('expandedHeight', parseInt(e.target.value) || 1742)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => updateConfig('collapseDuration', parseFloat(e.target.value) || 1)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                min="0.1"
                max="3"
                step="0.1"
      ...
      {hasVideo && !hasBackground && (
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm text-gray-600 mb-1">Video Height</label>
            <input
              type="number"
              value={config.videoHeight}
              onChange={(e) => updateConfig('videoHeight', parseInt(e.target.value) || 562)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
            <p className="text-xs text-gray-400 mt-1">pixels</p>
          </div>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => updateConfig('buttonCount', parseInt(e.target.value))}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
          ...
          {config.buttonCount > 0 && (
            <div className="space-y-3 mt-4">
              <h4 className="text-sm font-medium text-gray-600">Button Settings</h4>
              {Array.from({ length: config.buttonCount }).map((_, i) => {
                ...
                return (
                  <div key={i} className="border border-gray-200 rounded-lg p-3 bg-gray-50">
                    <div className="text-sm font-medium text-gray-700 mb-2">Button {i + 1}</div>
                    <div className="space-y-2">
                      <input
                        type="text"
                      ...
                      <div className="grid grid-cols-4 gap-2">
                        <input type="number" value={btn.left || 50} onChange={(e) => updateButton('left', parseInt(e.target.value))} className="px-2 py-1 border rounded text-xs" placeholder="Left" />
                        <input type="number" value={btn.top || 100} onChange={(e) => updateButton('top', parseInt(e.target.value))} className="px-2 py-1 border rounded text-xs" placeholder="Top" />
                        <input type="number" value={btn.width || 200} onChange={(e) => updateButton('width', parseInt(e.target.value))} className="px-2 py-1 border rounded text-xs" placeholder="W" />
                        <input type="number" value={btn.height || 50} onChange={(e) => updateButton('height', parseInt(e.target.value))} className="px-2 py-1 border rounded text-xs" placeholder="H" />
                      </div>
                    </div>
                  </div>
                )
